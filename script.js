async function searchHolidays() {
  ...
  const country = "IN"; // Change country code if needed

  const url = `https://holidays.abstractapi.com/v1/?api_key=YOUR_API_KEY&country=${country}&year=${year}&month=${month}&day=${day}`;
